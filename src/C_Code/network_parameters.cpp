...
network_parameters::network_parameters(const char* weights1, const char* weights2, const char* biases, const char* biases2, const char* full, const char* full2, const char* fo, const char* g){
	read_from_file(romcontents, weights1); 
	read_from_file(romcontents2, weights2); 
	read_from_file(bias, biases); 
	read_from_file(bias2, biases2);
