...
class network_parameters{
	public:	
		network_parameters(const char* weights1, const char* weights2, const char* bias, const char* bias2, const char* fully, const char* fully2, const char* final_bias, const char* b);
