...
public:
	...
	static MemoryControllerConfigPtr getMax2ConfigInstance(int dimm_count, int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t cmdQSize);
	static MemoryControllerConfigPtr getMax3ConfigInstance(int dimm_count, int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t cmdQSize);
	static MemoryControllerConfigPtr getMax4ConfigInstance(int dimm_count, int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t quarterMode, uint32_t cmdQSize);
	static MemoryControllerConfigPtr getMax4NConfigInstance(int dimm_count, int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t quarterMode, uint32_t cmdQSize);
