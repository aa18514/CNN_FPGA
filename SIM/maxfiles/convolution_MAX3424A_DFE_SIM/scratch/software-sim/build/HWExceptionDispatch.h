...
CAST_float2fixed(inline,) {
	return cast_float2fixed<r_size,r_offset,r_sign_mode,round_mode,a_esize,a_msize,false>(a,NULL);
}

CAST_float2fixed(inline,,EXCEPTFLOAT) {
	return cast_float2fixed<r_size,r_offset,r_sign_mode,round_mode,a_esize,a_msize,true>(a,exception);
}
