...
#ifndef VARINT64_S_H_
#define VARINT64_S_H_
...
//		{ }
	...
	{ m_ustore.template set_bits<base,length,size2>(varint_u<size2>(value)); }

	template<uint base, uint length, uint size2>
	void set_bits(varint_u<size2> value)
	{ m_ustore.template set_bits<base,length,size2>(value); }
...
//	}
	...
	const varint_u<width> slice() const {
		return m_ustore.template slice<base, width>();
	}
