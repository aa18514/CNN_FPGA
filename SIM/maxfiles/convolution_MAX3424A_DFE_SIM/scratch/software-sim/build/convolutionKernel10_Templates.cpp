...
template class HWOffsetFix<19,3,UNSIGNED>;
...
template class HWOffsetFix<16,3,UNSIGNED>;
...
template HWOffsetFix<16,0,UNSIGNED> cast_fixed2fixed<16,0,UNSIGNED,TONEAREVEN>(const HWOffsetFix<16,1,UNSIGNED> &a);
template HWOffsetFix<16,4,UNSIGNED> cast_bits2fixed<16,4,UNSIGNED>(const HWRawBits<16> &a);
template HWRawBits<32> slice<96,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<160,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<576,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<1216,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<1248,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<1120,32>(const HWRawBits<1280> &a);
template HWOffsetFix<16,3,UNSIGNED> cast_bits2fixed<16,3,UNSIGNED>(const HWRawBits<16> &a);
template HWRawBits<32> slice<416,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<352,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<384,32>(const HWRawBits<1280> &a);
template HWRawBits<16> cast_fixed2bits<>(const HWOffsetFix<16,0,UNSIGNED> &a);
template HWRawBits<32> slice<480,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<192,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<64,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<544,32>(const HWRawBits<1280> &a);
template HWOffsetFix<16,0,UNSIGNED> cast_fixed2fixed<16,0,UNSIGNED,TONEAREVEN>(const HWOffsetFix<19,3,UNSIGNED> &a);
template HWRawBits<64>shift_left_fixed<>(const HWOffsetFix<64,0,TWOSCOMPLEMENT> &a, long shift_by );
template HWRawBits<1280> KernelManagerBlockSync::readInput< HWRawBits<1280> >(const t_port_number port_number);
...
template HWOffsetFix<10,0,UNSIGNED> cast_fixed2fixed<10,0,UNSIGNED,TONEAREVEN>(const HWOffsetFix<16,0,UNSIGNED> &a);
template HWRawBits<32> slice<608,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<832,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<672,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<0,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<704,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<128,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<256,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<448,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<736,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<896,32>(const HWRawBits<1280> &a);
template HWOffsetFix<48,0,UNSIGNED> cast_fixed2fixed<48,0,UNSIGNED,TRUNCATE>(const HWOffsetFix<49,0,UNSIGNED> &a);
template HWRawBits<32> slice<1056,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<1152,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<288,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<1184,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<512,32>(const HWRawBits<1280> &a);
template HWOffsetFix<11,0,UNSIGNED> cast_fixed2fixed<11,0,UNSIGNED,TONEAREVEN>(const HWOffsetFix<16,0,UNSIGNED> &a);
...
template HWRawBits<32> slice<800,32>(const HWRawBits<1280> &a);
template HWOffsetFix<16,1,UNSIGNED> cast_bits2fixed<16,1,UNSIGNED>(const HWRawBits<16> &a);
template HWRawBits<32> slice<32,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<864,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<1024,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<992,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<1088,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<768,32>(const HWRawBits<1280> &a);
...
template HWRawBits<32> slice<320,32>(const HWRawBits<1280> &a);
template HWRawBits<32> slice<224,32>(const HWRawBits<1280> &a);
template HWOffsetFix<32,-24,TWOSCOMPLEMENT> cast_bits2fixed<32,-24,TWOSCOMPLEMENT>(const HWRawBits<32> &a);
template HWRawBits<32> slice<928,32>(const HWRawBits<1280> &a);
template HWOffsetFix<19,3,UNSIGNED>add_fixed <19,3,UNSIGNED,TONEAREVEN,16,3,UNSIGNED,16,5,UNSIGNED, false>(const HWOffsetFix<16,3,UNSIGNED> &a, const HWOffsetFix<16,5,UNSIGNED> &b , EXCEPTOVERFLOW);
template HWRawBits<32> slice<960,32>(const HWRawBits<1280> &a);
template HWOffsetFix<64,0,TWOSCOMPLEMENT> cast_bits2fixed<64,0,TWOSCOMPLEMENT>(const HWRawBits<64> &a);
template HWRawBits<32> slice<640,32>(const HWRawBits<1280> &a);
